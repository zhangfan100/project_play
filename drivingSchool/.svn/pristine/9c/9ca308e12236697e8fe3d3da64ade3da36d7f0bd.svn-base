    ...
    baidu.object.extend(SearchInfoWindow.prototype,{
                        ...
                        '<div class="BMapLib_nav" id="BMapLib_nav' + this.guid + '">',
                            ...
                            '<ul class="BMapLib_nav_tab_content">', //tab内容
                                ...
                                '<li id="BMapLib_transBox' + this.guid + '" style="display:none">',
                                    '<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>',
                                        '<tr><td width="30" style="padding-left:8px;"><div id="BMapLib_stationText' + this.guid + '" style="width:40px">起点</div></td><td><input id="BMapLib_trans_text' + this.guid + '" class="BMapLib_trans_text" type="text" maxlength="100" autocomplete="off"></td><td width="106" style="padding-left:7px;"><input id="BMapLib_search_bus_btn' + this.guid + '" type="button" value="公交" class="iw_bt" style="margin-right:0px;"><input id="BMapLib_search_drive_btn' + this.guid + '" type="button" class="iw_bt" value="驾车"></td></tr>',
                                    '</table>',
                                '</li>',
                            '</ul>',
                        '</div>',
     ...
     baidu.extend(Popup.prototype, {
         ...
         bind: function() {
             ...
             baidu.on(phone0, 'keydown', function(e){
             });
         ...
         generalMessage: function() {
             ...
             this.request(this.config.shortURL, params, function(result){
                 msg += "查看地图：" + result.rinyurl ? result.tinyurl : uri;
         ...
         config: {
             sendURL       : "http://10.48.233.152:8091/ws/message?method=send",
             activateURL   : "http://10.48.233.152:8091/ws/message?method=activate",
             ckActivateURL : "http://10.48.233.152:8091/ws/message?method=ckActivate",
             shortURL      : "http://10.48.233.152:8091/ws/dwz?method=create"
         }
