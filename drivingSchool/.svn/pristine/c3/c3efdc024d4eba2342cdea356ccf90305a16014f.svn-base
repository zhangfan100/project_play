...
@Controller
@RequestMapping("stu")
public class stuCommentAction extends BaseAction{
	...
	public String addComment(Integer lessonInfoId){
		request.setAttribute("currLessonInfo", iLessonInfoService.getLessonInfoById(lessonInfoId));
		return "student/commentManageAction/editComment"; 
	}
	/**
	 * 添加评论
	 * @param review
	...
	public int addCommentSubmit(TrainReview review){
