...
<body >
	...
	<div class="easyui-layout" data-options="fit:true" >
		<div class="center-filter clearfix" data-options="region:'north',border:false">
			<!-- 标题 -->
			<span class="table-title">工资发放记录列表</span>
	...
	$("#financialLog-Grid").datagrid({    
	    ...
	    columns:[[    
	        ...
	        {field:'operateName',title:'操作人',width:60,align:'center'},
	        {field:'type',title:'发放类型',width:60,align:'center',formatter:typeFormatter},
	        {field:'name',title:'领薪人',width:60,align:'center'},
	        {field:'salaryTime',title:'工资周期',width:80,align:'center'},
	        {field:'cash',title:'应发工资',width:60,align:'center'},
	        {field:'realCash',title:'实发工资',width:60,align:'center'},
	        {field:'payWay',title:'发放方式',width:60,align:'center',formatter:payWayFormatter},
	        {field:'payTime',title:'发放日期',width:80,align:'center'},
	        {field:'content',title:'备注',width:150,align:'center'},
	    ]]    
	});
