...
<body id="maglogin">
	...
	<div class="login_table">
		...
		<!-- <div class="form-group" style="margin-left:50px">
			<div class="col-sm-5">
				<input type="radio" name="optionsRadiosinline" id="optionsRadios3" value="1"  checked><label for="optionsRadios3"><span>教员</span></label>
			</div>
			<div class="col-sm-5">
				<input  type="radio" name="optionsRadiosinline" id="optionsRadios4" value="2" checked><label for="optionsRadios4"><span>管理员</span></label>
			</div> 
	   </div> -->
		<div style="clear:both"></div>
			...
			$.post(forwardFlag==0?teacherUrl:magUrl,formData,function(data){
				if(forwardFlag==0){
					if(data=='1'){
						...
						window.location.href= "${path}/coh/cohIndex";
					}
				}else{
					switch(data*1){
						...
						case 0 :window.location.href="${path}/coh/cohIndex";
					}
				}
			});
		}
