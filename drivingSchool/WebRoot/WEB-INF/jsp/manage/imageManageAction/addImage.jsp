	...
	<style>
	 ...
	 <div class="easyui-layout" data-options="fit:true">
	 	 <div data-options="region:'north',border:false" style="height:40px;padding:7px;">
	 	 	上传到:
				<select id="imgKind" class="easyui-combobox" name="kind"  style="width:200px;" editable="false" panelHeight="auto">
					<option value="1">首页大图 700*370</option>
					<option value="2">场地图片</option>
	 ...
	 <div id="addItemTemplate" class="imgItem" style="display:none">
	 	...
	 	<div class="input">
	 		<input placeholder="图片描述..." name="title" class="title"/>
	 	</div>
	 </div>
	 ...
	 <script type="text/javascript">
	 	...
	 	function startUpload(){
	 		...
	 		$("#imgContiner .imgItem").each(function(){
	 			...
	 			item['title'] = _this.find(".title").val();
	 			item['type'] = $("#imgKind").combobox("getValue");
	 			param.push(item);
	 		});
